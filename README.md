...
### О приложении
Кластерный анализ и профиль рынка позволяет определить действительную заинтересованность участников рынка. 
Был реализован один из методов работы с профилем рынка - реакция на максимальный горизонтальный объем внутри дня за выбранный период.

[//]: # (Проведен анализ истории в промежутке с 04-05-22 по 20-05-22. Реализованная стратегия дает положительное математическое ожидание при подборе параметров &#40;результаты представлены в logs/statistics&#41;.)
[//]: # (Проведено тестирование приложения в песочнице;)
