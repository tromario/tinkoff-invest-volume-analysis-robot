...
| SANDBOX_ACCOUNT_ID   | Счет для торговли в песочнице                                        | -                      |
| REAL_ACCOUNT_ID      | Счет для торговли на реальном счете                                  | -                      |
...
| COUNT_LOTS           | Количество лотов на 1 точку входа                                    | -                      |
